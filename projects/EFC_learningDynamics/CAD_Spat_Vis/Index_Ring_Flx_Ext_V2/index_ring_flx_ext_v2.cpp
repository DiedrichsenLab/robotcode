...
///////////////////////////////////////////////////////////////
#include "index_ring_flx_ext_v2.h" 
	...
	LPSTR kposzArgs, int nWinMode)
{
	...
	gThisInst = hThisInst;
	gExp = new MyExperiment("index_ring_flx_ext", "index_ring_flx_ext", "C:/data/EFC_learningDynamics/CAD_Spat_Vis/Index_Ring_Flx_Ext_V2/"); 
	...
	//gBox[1].init(BOX_RIGHT,"c:/robot/calib/Flatbox1_highforce_RIGHT _31-July-2017.txt");
