...
private:
	...
	double endForces[5] = { 0, 0, 0, 0, 0 };
	double endForcesPurturbed[5] = { 0, 0, 0, 0, 0 };				///< The end forces with purturbation added for simulating perturbation in the force feedback
