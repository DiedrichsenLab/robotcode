...
public: 
	...
	double getAD(int channel,int board=0);					     ///< returns value for AD in voltage
	int registerAD(int channel,int range,int board=0);			 ///< puts an AD-channel on the poll-list 
