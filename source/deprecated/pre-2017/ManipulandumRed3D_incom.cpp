...
#include "ManipulandumRed3D_incom.h"
...
//	Lgain = 0.000010;
	...
	Lmat[4]=0.10;
	Lmat[5]=0.4;
	Lmat[6]=0.10; //6 is different to 4 due to asymetrical learning rate
	...
	open_fb_file("C:\\robot\\testdata\\feedfor_tests\\FF_spirograph_15_040712_2.txt");
...
////////////////////////////////////////////////////////////////////////////////
	...
	sprintf(manipbuffer,"qe[0]=%3.8f, qe[1]=%3.8f",qe[0],qe[1]);
	tDisp.setText(manipbuffer,14,col);
...
void Manipulandum::updateWristTorqueControl(double dt) ///< updates wrist angle PID controller
{
		...
		torqueDemanded[2]=wristTDemandTorque;
}
...
void Manipulandum::CalcPsi(Vector2D q,Vector2D qd,Vector2D qdd)
{
