...
private:
	...
	int holdTime;							///< duration to hold the chord
	...
	double RT;								///< reaction time: the time when the first finger goes out of the baseline after go-cue.
	double ET;								///< Execution time: time from go cue to full execution of chord
