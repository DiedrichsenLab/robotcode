...
void MyTrial::read(istream& in) {
	// read from .tgt file
	in >> subNum >> hand >> isTrain >> symbol >> cue >> isMasked >> execTime >> iti >> precueTime >> windowSize;
...
void MyTrial::writeDat(ostream& out) {
	// write to .dat file
	out << subNum << "\t" << hand << "\t" << isTrain << "\t" << symbol << "\t" << cue << "\t" << isMasked << "\t" 
...
void MyTrial::writeHeader(ostream& out) {
	...
	out << "SubNum" << "\t" << "hand" << "\t" << "isTrain" << "\t" << "symbol" << "\t" << "cue" << "\t" <<
		"isMasked" << "\t" << "precueTime" << "\t" << "windowSize" << "\t";
