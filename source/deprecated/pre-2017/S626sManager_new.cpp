...
S626sManager::S626sManager(){ 
	S626_DLLOpen();
	int c,b; 
	for (b=0;b<NUMBOARDS;b++) {			///< Keep track of which AD channels are allocated 
		for (c=0;c<16;c++){ 
			isUsedAD[b][c]=false;
		} 
		for (c=0;c<4;c++){ 
...
// -----------------------------------------------------------------------
void S626sManager::initInterrupt(void (*fcn)(void),int updateR) { 
...
////////////////////////////////////////////////////////////////////////////////
/// Register a AD channel on the card 
/// \param c number of the channel to register 
/// \param r voltage range 5 or 10 V  
/// \param b board number (defaults to 0 for one board only) 
/// \return number of channels allocated on the board 
/// 
////////////////////////////////////////////////////////////////////////////////
int S626sManager::registerAD(int c,int r,int b){ 
	...
	for (int i=0;i<numAD[b];i++){ 
		cout<<c<<"\t"<<(int)poll_list[b][i]<<endl;
	} 
	return(numAD[b]-1);
}

////////////////////////////////////////////////////////////////////////////////
/// return the registered AD channels on the board 
/// This simply returns the value from the current data buffer, 
/// Use updateAD to refresh buffer 
/// \param c channel to be returned 
/// \param b board number to update 
/// 
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// Update all registered AD channels on the board 
/// Warning: this is a time-consuming function, so please only call once 
/// per haptic update cycle. 
//  Use getAD to return the state of each channel afterwards  
/// \param b board number to update 
/// 
////////////////////////////////////////////////////////////////////////////////
...
void S626sManager::outDIO(int channel, short setting, int board){
	...
	if (setting!=0 && setting!=1) { 
		cout<<"s626DIO: illegial setting (0/1)"<<endl;
	} 
